...
import com.rtsbuilding.rtsbuilding.client.command.RtsClientStressCommand;
...
public final class RtsClientModEvents {
    ...
    public static void registerClientCommands(RegisterClientCommandsEvent event) {
        event.getDispatcher().register(RtsClientStressCommand.build());
    }

    @SubscribeEvent
    public static void onClientTick(ClientTickEvent.Post event) {
        RtsClientStressCommand.tickClient();
    }
}
