...
final class NbtStringLimits {
    static final int MAX_MODIFIED_UTF_BYTES = 65_535;

    private NbtStringLimits() {
    }

    static int requireWritable(String value, String field) {
    ...
    static int modifiedUtfBytes(String value) {
        long bytes = 0L;
