...
public final class BlockPlacer {
    ...
    /**
     * 静默放置——仅同步客户端，不触发邻居方块更新。
     * 批量建造场景下大幅降低每 tick 开销。
     */
    public static boolean setBlockSilent(ServerLevel level, BlockPos pos, BlockState state) {
